...
class Solution {
   ...
   public Tree cloneTree(Tree tree){
       addDuplicate(tree) ;
       addRandom(tree) ;
       Tree dup = removeDup(tree) ;
       return dup ;
   }
   public void addDuplicate(Tree node){
       if(node == null){
           return ;
       }
       
       addDuplicate(node.left) ;
       addDuplicate(node.right) ;
   ...
   public void addRandom(Tree node){
       if(node == null){
           return ;
       }
       addRandom(node.left.left) ;
       addRandom(node.right) ;
       if(node.random != null){
   ...
   public Tree removeDup(Tree node){
       ...
       Tree left = removeDup(node.left.left) ;
       Tree right = removeDup(node.right) ;
